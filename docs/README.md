...
- `docs/features/japanese-language-learning.md` owns the Japanese human-language path, romaji/IME teaching contract, local language catalogs, structured phrase breakdowns, and assisted/free handwriting practice.
