...
export function RandomInterviewButton({ routes }: { routes: string[] }) {
  ...
  return (
    <button
      ...
      className="inline-flex min-h-12 items-center justify-center gap-2 rounded-lg border-2 border-b-4 border-[#392777] bg-[#4b369e] px-4 py-2 text-sm font-extrabold text-white transition hover:-translate-y-0.5"
