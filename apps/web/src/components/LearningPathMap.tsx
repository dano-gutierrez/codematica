...
export function LearningPathHome({ index, keepReadingItems = [], isSignedIn = false }: { index: ContentIndex; keepReadingItems?: ProgressDisplayItem[]; isSignedIn?: boolean }) {
  return (
          ...
          <div className="min-w-0">
            <div className="flex flex-col gap-3">
              ...
              <p className="max-w-3xl text-base font-semibold leading-7 text-[#68737d]">
                Follow role, skill, and language paths made from documents, diagrams, flashcards, writing drills, and fill-the-gap practice.
              </p>
            </div>
            ...
            <div className="mt-5 grid gap-5" data-testid="learning-path-list">
    ...
    <header className="border-b-2 border-[#d5e2e8] bg-white px-4 py-4">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4">
        ...
        <nav className="flex items-center gap-2">
          ...
          <Link
            href="/login"
            className="inline-flex min-h-10 items-center rounded-lg border-2 border-b-4 border-[#d5e2e8] bg-white px-3 py-2 text-sm font-extrabold text-[#263238]"
          >
            Sign in
          </Link>
        </nav>
