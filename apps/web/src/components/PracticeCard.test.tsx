...
describe("PracticeCard", () => {
  it("reveals flashcard answers on demand", () => {
    ...
    expect(onProgressEvent).toHaveBeenCalledWith("completed", { revealed: true });
  });
  ...
  it("checks cloze answers case-insensitively after trimming", () => {
    ...
    expect(onProgressEvent).toHaveBeenCalledWith("completed", { correct: true });
  });
  ...
  it("renders Japanese writing practice with assisted and free modes", () => {
    ...
    render(<PracticeCard exercise={exercise!} />);
